            ...
            try {
                ...
                if (requestType.equals("autoLogin")) {//자동로그인을 위한 통신을 한 경우
                    ...
                    if (isChatServiceRunning()) {
                        ...
                        Log.d("채팅 서비스", "최초 실행");
                        Intent serviceIntent = new Intent(getApplicationContext(), ChatIntentService.class);
...
/*
    ...
    public boolean isChatServiceRunning() {
        ...
        for (ActivityManager.RunningServiceInfo service : activityManager.getRunningServices(Integer.MAX_VALUE)) {
            if (ChatIntentService.class.getName().equals(service.service.getClassName())) {
                return true;
            }
        }
        return false;
