...
import g.sns_test.InsertUser;
import g.sns_test.LoginActivity;
import g.sns_test.R;
...
public class JoinActivity extends AppCompatActivity {
    ...
    //private TextView textView_id, textView_password, textView_passwordCheck, textView_name, textView_nickname;
        ...
        btn_join.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //모든 항목들이 회원가입을 하기에 적합하게 입력된 경우
                    ...
                    //이메일 인증 번호를 생성하는 메소드
                    //param: 사용자가 입력한 이메일
                    String verificationNum = SendEmail.randomNum();
